...
const astoolsModule = (function () {
    ...
    // TODO: not working. element check returns null
    /*
    const get_kaltura_status__ = function(batch_name) {
        console.log('get_kaltura_status', batch_name);
        try {
            // TODO: get status using data-kaltura property
            // const job_uuid = button.dataset.jobUuid;
            // <tr data-batch="new_U358_LDT_TEST_Collection-resources_1204" data-kaltura="true"><td class="batch-name-cell"><small>new_U358_LDT_TEST_Collection-resources_1204</small></td><td class="packages-list-cell"><ul class="package-list"><li><small>B133.01.0003.00001</small></li></ul></td><td class="type-cell"><small>Kaltura Items</small></td><td class="actions-cell"><button type="button" class="btn btn-sm btn-default run-qa action-start-button" data-batch="new_U358_LDT_TEST_Collection-resources_1204"><i class="fa fa-cogs"></i><span> Start</span></button></td></tr>
            const element = document.getElementById(batch_name);
            console.log('get_kaltura_status element ', element);
